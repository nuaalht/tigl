...
namespace tigl
{
    namespace generated
    {
        ...
        void CPACSStringerFramePosition::SetContinuity(const CPACSContinuity& value)
        {
            m_continuity = value;
        }
        ...
        void CPACSStringerFramePosition::SetInterpolation(const CPACSInterpolation& value)
        {
