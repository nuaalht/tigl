...
namespace tigl
{
    namespace generated
    {
        ...
        void CPACSLongFloorBeamPosition::SetContinuity(const CPACSContinuity& value)
        {
            m_continuity = value;
        }
        ...
        void CPACSLongFloorBeamPosition::SetInterpolation(const CPACSInterpolation& value)
        {
